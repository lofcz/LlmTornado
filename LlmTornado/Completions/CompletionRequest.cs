...
///     <see href="https://beta.openai.com/api-ref#create-completion-post">the OpenAI docs</see>, although some have been
///     renamed or expanded into single/multiple properties for ease of use.
/// </summary>
public class CompletionRequest
{
    ...
    {
        Model = Models.Model.DefaultModel;
    }
	...
	/// <summary>
	///     Include the log probabilities on the logprobs most likely tokens, which can be found in
	///     <see cref="CompletionResult.Completions" /> -> <see cref="Choice.Logprobs" />. So for example, if logprobs is 5,
	///     the API will return a list of the 5 most likely tokens. If logprobs is supplied, the API will always return the
	///     logprob of the sampled token, so there may be up to logprobs+1 elements in the response.  The maximum value for
	///     logprobs is 5.
	/// </summary>
