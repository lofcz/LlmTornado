...
{
	/// <summary>
	///     Instantiates a new Authentication object with the given <paramref name="apiKey" />, which may be
	///     <see langword="null" />.
	/// </summary>
	...
	/// <summary>
	///     Instantiates a new Authentication object with the given <paramref name="apiKey" />, which may be
	///     <see langword="null" />.  For users who belong to multiple organizations, you can specify which organization is
	///     used. Usage from these API requests will count against the specified organization's subscription quota.
	/// </summary>
	/// <param name="apiKey">The API key, required to access the API endpoint.</param>
	...
	/// <summary>
	///     The API key, required to access the API endpoint. Set to null if no API key is required (eg. for locally hosted
	///     models)
	/// </summary>
