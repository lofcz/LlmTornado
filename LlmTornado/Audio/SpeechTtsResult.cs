...
public class SpeechTtsResult : ApiResultBase
{
    ...
    ///     You are responsible for disposing of this stream! Use helper method <see cref="SaveAndDispose" /> to do that
    ///     automatically
    /// </summary>
    ...
    /// <summary>
    ///     Http response, you are responsible for disposing of this! Use helper method <see cref="SaveAndDispose" /> to do
    ///     that automatically
    /// </summary>
