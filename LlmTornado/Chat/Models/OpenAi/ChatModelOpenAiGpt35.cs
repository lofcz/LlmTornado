...
public class ChatModelOpenAiGpt35 : IVendorModelClassProvider
{
    ...
    /// </summary>
    public static readonly ChatModel ModelTurbo = new ChatModel("gpt-3.5-turbo", LLmProviders.OpenAi);
    ...
    /// </summary>
    public static readonly ChatModel ModelTurbo240125 = new ChatModel("gpt-3.5-turbo-0125", LLmProviders.OpenAi);
    ...
    /// </summary>
    public static readonly ChatModel ModelTurbo231106 = new ChatModel("gpt-3.5-turbo-1106", LLmProviders.OpenAi);
    ...
    /// </summary>
    public static readonly ChatModel ModelTurboInstruct = new ChatModel("gpt-3.5-turbo-instruct", LLmProviders.OpenAi);
