...
public class CompletionEndpoint : EndpointBase, ICompletionEndpoint
{
    ...
    /// <summary>
    ///     Ask the API to complete the prompt(s) using the specified request and a requested number of outputs.  This is
    ///     non-streaming, so it will wait until the API returns the full result.
    /// </summary>
    /// <param name="request">
    ///     The request to send to the API.  This does not fall back to default values specified in
    ///     <see cref="DefaultCompletionRequestArgs" />.
    ...
    /// <summary>
    ///     Ask the API to complete the prompt(s) using the specified parameters.  This is non-streaming, so it will wait until
    ///     the API returns the full result.  Any non-specified parameters will fall back to default values specified in
    ///     <see cref="DefaultCompletionRequestArgs" /> if present.
    /// </summary>
    ...
    ///     <see cref="CompletionResult.Completions" /> -> <see cref="Choice.Logprobs" />. So for example, if logprobs is 10,
    ///     the API will return a list of the 10 most likely tokens. If logprobs is supplied, the API will always return the
    ...
    /// <summary>
    ///     Ask the API to complete the prompt(s) using the specified promptes, with other paramets being drawn from default
    ///     values specified in <see cref="DefaultCompletionRequestArgs" /> if present.  This is non-streaming, so it will wait
    ///     until the API returns the full result.
    /// </summary>
    ...
    ///     <see cref="StreamCompletionAsync(CompletionRequest, Action{CompletionResult})" /> instead.
    /// </summary>
    /// <param name="request">
    ///     The request to send to the API.  This does not fall back to default values specified in
    ///     <see cref="DefaultCompletionRequestArgs" />.
    ...
    ///     Any non-specified parameters will fall back to default values specified in
    ///     <see cref="DefaultCompletionRequestArgs" /> if present.
    ///     If you are not using C# 8 supporting async enumerables or if you are using the .NET Framework, you may need to use
    ///     <see cref="StreamCompletionAsync(CompletionRequest, Action{CompletionResult})" /> instead.
    /// </summary>
