...
public interface IAssistantsEndpoint
{
    ...
    public Task<bool> RemoveFileAsync(string assistantId, string fileId, CancellationToken? cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
    /// <returns>True, if file was removed.</returns>
    public Task<bool> RemoveFileAsync(string assistantId, File file, CancellationToken? cancellationToken = default);
}