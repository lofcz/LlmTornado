...
> **Legacy API:** Retained for existing Assistants integrations. Prefer [Responses](/llmtornado/responses/overview) response chaining or [Agents](/agents/getting-started) for new applications.
...
- Understanding of [Assistants](/llmtornado/assistants/basics)
...
- [Assistants](/llmtornado/assistants/basics) - Creating and managing assistants
- [Vector Stores](/llmtornado/vector-stores/basics) - Knowledge bases for assistants
- [Chat Basics](/llmtornado/chat/basics) - Core conversation concepts
- [Files](/llmtornado/files/basics) - File attachments
