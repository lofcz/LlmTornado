...
> **Legacy API:** Retained for older text-completion integrations. Prefer [Chat](/llmtornado/chat/basics) or [Responses](/llmtornado/responses/overview) for new applications.
...
- [Chat Basics](/llmtornado/chat/basics) - Recommended chat interface
- [Models](/llmtornado/chat/models) - Available models
