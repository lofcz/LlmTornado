...
3. Understanding of [Chat Basics](/llmtornado/chat/basics)
...
- [Chat Basics](/llmtornado/chat/basics) - Fundamental chat concepts
- [Structured Output](/llmtornado/chat/structured-output) - Working with JSON schemas
- [Vision](/llmtornado/vision/basics) - Detailed vision capabilities
- [Streaming](/llmtornado/chat/streaming) - Real-time message streaming
