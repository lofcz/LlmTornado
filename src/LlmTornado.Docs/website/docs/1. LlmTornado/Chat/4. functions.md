...
- [Agent Function Tools](/agents/tornado-agent/tools/function-tools) - Use functions in agent loops
- [Responses API](/llmtornado/responses/overview) - Responses function tools and typed events
- [Streaming](/llmtornado/chat/streaming) - Streaming responses with function calls
