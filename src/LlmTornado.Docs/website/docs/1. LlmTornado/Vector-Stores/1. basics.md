...
- Understanding of [Embeddings](/llmtornado/embedding/basics)
- Familiarity with [Files](/llmtornado/files/basics) and [Assistants](/llmtornado/assistants/basics)
...
- [Embeddings](/llmtornado/embedding/basics) - Understanding embeddings
- [Assistants](/llmtornado/assistants/basics) - Using with assistants
- [Files](/llmtornado/files/basics) - File management
- [Vector Databases](/vectordatabases/getting-started) - External vector databases
