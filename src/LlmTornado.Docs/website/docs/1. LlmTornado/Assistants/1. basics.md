...
> **Legacy API:** Retained for existing integrations. Prefer [Responses](/llmtornado/responses/overview) or [Agents](/agents/getting-started) for new applications.
...
- Understanding of [Chat Basics](/llmtornado/chat/basics)
- Familiarity with [Threads](/llmtornado/threads/basics) for conversations
...
- [Threads](/llmtornado/threads/basics) - Managing conversations with assistants
- [Vector Stores](/llmtornado/vector-stores/basics) - File-based knowledge bases
- [Files](/llmtornado/files/basics) - File management
- [Agents](/agents/getting-started) - Higher-level agent abstractions
