...
/// <summary>
/// Result of <see cref="ResponseRequest"/>.
/// </summary>
public class ResponseResult
{
    ...
    internal object? Instructions { get; set; }
    ...
    /// - The length and order of items in the output array is dependent on the model's response.<br/>
