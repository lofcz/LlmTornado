...
/// <summary>
/// A source URL used in a web search action.
/// </summary>
...
/// <summary>
/// A call to a custom tool that was invoked by the model.
/// </summary>
public class ResponseCustomToolCallItem : IResponseOutputItem
{
    /// <inheritdoc/>
    [JsonProperty("type")]
    public string Type { get; set; } = "custom_tool_call";
    ...
    /// <summary>
    /// The unique identifier for this custom tool call, used to match it with its output.
    /// </summary>
    [JsonProperty("call_id")]
    public string CallId { get; set; } = string.Empty;
    ...
    /// <summary>
    /// The input to the custom tool call generated by the model.
    /// </summary>
    [JsonProperty("input")]
