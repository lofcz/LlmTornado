...
public class ResponseInputMessage : ResponseInputItem
{
    ...
    public List<InputContent> Content { get; set; } = new();
...
public class ComputerToolCallOutput : ResponseInputItem
{
    ...
    /// </summary>
    [JsonProperty("output")]
    public ComputerScreenshot Output { get; set; } = new();
...
public class ComputerToolCallInput : ResponseInputItem
{
    ...
    public List<PendingSafetyCheck> PendingSafetyChecks { get; set; } = new();
