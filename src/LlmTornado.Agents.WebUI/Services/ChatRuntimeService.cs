...
{
    public class ChatRuntimeService : ChatService
    {
        public ChatRuntimeService(HttpClient httpClient, IJSRuntime jsRuntime, IConfiguration configuration) : base(httpClient, jsRuntime, configuration)
        {
        }
