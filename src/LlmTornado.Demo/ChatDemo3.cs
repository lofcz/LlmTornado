...
public partial class ChatDemo : DemoBase
{
    ...
    public static async Task ConversationCompressionHookable()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            bool compressed = await conversation.CheckAndCompress();
    ...
    public static async Task ConversationCompressionAdaptive()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            conversation.AddUserMessage($"Short question {i + 1}");
            bool compressed = await conversation.CheckAndCompress();
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            conversation.AddUserMessage(longMessage);
            bool compressed = await conversation.CheckAndCompress();
    ...
    public static async Task ConversationCompressionPeriodic()
    {
        ...
        for (int i = 0; i < 25; i++)
        {
            conversation.AddUserMessage($"Message {i + 1}");
            bool compressed = await conversation.CheckAndCompress();
    ...
    public static async Task ConversationCompressionSmartInsertWithResponse()
    {
        ...
        foreach (string query in queries)
        {
            ...
            conversation.AddUserMessage(query);
            await conversation.CheckAndCompress();
            ChatRichResponse response = await conversation.GetResponseRich();
            await conversation.CheckAndCompress();
